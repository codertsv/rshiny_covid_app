#server.R
#
# Advanced COVID-19 shiny app (plotly)
# 
...
# Adapted by Kevin R. Bairos-Novak
# 
# Data from:
# Johns Hopkins University Center for System Science and Engineering (JHU CCSE)
# 
# View the app in action at: https://ecolology.shinyapps.io/covid_plotter/

library(tidyverse) 

baseURL = "https://raw.githubusercontent.com/CSSEGISandData/COVID-19/master/csse_covid_19_data/csse_covid_19_time_series"

f1 = list(family="Arial, monospace", size=11, color="rgb(30,30,30)")
...
function(input, output, session) {
	...
	# observeEvent function waits for changes in input$country, 
	# updates the selections possible for the 'states' part of the UI
